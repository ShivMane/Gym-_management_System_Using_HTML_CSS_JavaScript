          ...
          <div class="col-md-6">
            ...
            <div class="card card-success" >
              <div class="card-header">
                <h3 class="card-title" style="color: #fff;font-weight: bold;">Member Information Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
               <form enctype="multipart/form-data" action="add_mem.php" method="POST">
                <div class="card-body">

                  <h5 style="color: yellow;font-weight: bold;">Member Information</h5>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control"  name="occu" id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputEmail1"> Mobile</label>
                      <input type="number" class="form-control" name="mobile" id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <label for="exampleInputEmail1">Health Issue</label>
                      <input type="text" class="form-control" name="health" id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                   ...
                   <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="time" class="form-control" name="itime" id="" >
                    </div>

                    <div class="col-md-6">
                      <label for="exampleInputEmail1"> Out Time </label>
                      <input type="time" class="form-control" name="otime" id="exampleInputEmail1" >
                    </div>
                   </div>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Member Photo</label>
...
if(isset($_POST['add']))
{
  ...
  if(mysqli_query($con,"INSERT INTO owner_add_mem VAlUES('','".$fname."','".$lname."','".$dob."','".$occupation."','".$mobile."','".$emobile."','".$health."','".$email."','".$intime."','".$outtime."','".$city."','".$address."','".$gender."','".$_SESSION['owner']."','".$targetfile."')"))
  {
    echo"
    <script>
    alert('Member Account Added');
    window.location.href='add_mem.php';
    </script>
    ";
  }
  else
