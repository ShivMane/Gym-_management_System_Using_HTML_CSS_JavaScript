          ...
          <div class="col-md-6">
            ...
            <div class="card card-success" >
              <div class="card-header">
                <h3 class="card-title" style="color: #fff;font-weight: bold;">Staff Information Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form enctype="multipart/form-data" action="add_staff.php" method="POST">
                <div class="card-body">

                  <h5 style="color: yellow;font-weight: bold;">Staff Information</h5>
                  <hr>

                 <div class="row">
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Firstname</label>
                      <input type="name" class="form-control" name="fname"id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Lastname</label>
                      <input type="name" class="form-control" name="lname" id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Work At Gym</label>
                      <input type="name" class="form-control"name="work" id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Mobile No</label>
                      <input type="name" class="form-control" name="mobile"id="exampleInputEmail1" >
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Emergency Mobile No</label>
                      <input type="number" class="form-control"name="emobile" id="exampleInputEmail1" >
                    </div>
                     <div class="col-md-6">
                   ...
                   <div class="row">
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Duty Start</label>
                      <input type="time" class="form-control" name="dstart"id="" >
                    </div>

                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Duty End </label>
                      <input type="time" class="form-control" name="dend"id="exampleInputEmail1" >
                    </div>
                   </div>
                   ...
                   <div class="col-md-6">
                      ...
                      Male: <input type="radio" name="a"  checked value="Male">
                      Female: <input type="radio" name="a" value="Female">
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputEmail1">Staff Photo</label>
...
if(isset($_POST['add']))
{
  ...
  $gender=$_POST['a'];
   $max1=mysqli_query($con,"SELECT MAX(ID) FROM owner_add_mem");
  ...
  if(mysqli_query($con,"INSERT INTO owner_add_staff VAlUES('','".$fname."','".$lname."','".$dob."','".$work."','".$mobile."','".$emobile."','".$experience."','".$email."','".$dstart."','".$dend."','".$city."','".$address."','".$gender."','".$_SESSION['owner']."','".$targetfile."')"))
    {
    echo"
    <script>
