 <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- Messages Dropdown Menu add      <li class="nav-item dropdown">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="mem_atd_add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Attendance</p>
                </a>
              </li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="#" class="nav-link">
             ...
             <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_mem_type.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Types</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="view_mem_type.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Types</p>
                </a>
              </li>
